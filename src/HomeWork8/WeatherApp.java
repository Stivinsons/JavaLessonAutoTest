...
public class WeatherApp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String timeResponse = objectMapper.readTree(responseBodyWeatherFromCityID).at("/Headline/EffectiveDate")
                .asText().split("T")[0];//Дата для кеширования
        for (int day = 0; day < 5; day++) {
            ...
            WeatherFromEveryDay weatherFromEveryDay = new WeatherFromEveryDay
                    (timeResponse, cityID, weatherForEveryDay);
            DataBaseRepository dataBaseRepository = new DataBaseRepository();
            dataBaseRepository.saveWeather(weatherFromEveryDay);
        }
        DataBaseRepository dataBaseRepositoryForGetWeather = new DataBaseRepository();
        dataBaseRepositoryForGetWeather.getWeather();
    }
